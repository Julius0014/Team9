...
{
  unsigned int ii ;  // Overcome MSVC++ Weirdness
...
// this function reads the quantization value for a give index
UBYTE2 JpegDecoderQuantizationTable::GetDataValue (int index) const
{
	return (data_values[JpegZigZagOutputOrder(index)]);
